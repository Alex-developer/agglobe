...
extern int  gifout_open_file(FILE *, int, int, int, BYTE [3][256], int);
extern int  gifout_open_image(int, int, int, int);
extern void gifout_put_pixel(int);
extern void gifout_put_row(int *);
extern int  gifout_close_image(void);
extern int  gifout_close_file(void);
