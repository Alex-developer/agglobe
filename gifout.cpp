...
static int  cmap_bits(int);
static int  root_bits(int);
static void put_clr_code(void);
static void write_data_block(int, BYTE *, FILE *);
static void reset_string_out(void);
static void add_string_out(int, int);
static int  find_string_out(int, int);
static void gifout_fatal(const char *) _noreturn;
 ...
 */
int gifout_open_file(FILE *s, int w, int h, int sz, BYTE cmap[3][256], int bg)
     //FILE *s;
 ...
 */
int gifout_open_image(int left, int top, int w, int h)
...
static void write_data_block(int cnt, BYTE *outbuf, FILE *s)
{
  putc(cnt, s);
...
static void add_string_out(int p, int e)
{
  int idx;
...
static int find_string_out(int p, int e)
{
  int idx;
  int tmp;
  int rslt;
 ...
 */
static void gifout_fatal(const char *msg)
{
  fprintf(stderr, "\n");
