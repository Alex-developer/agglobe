...
static void        builtin_marker_info(void);
static void        user_marker_info(char *);
static void        process_line(char *, const char *, int);
static const char *decode_marker_info(int, char **);
static const char *decode_extra_marker_info(int, char **, MarkerInfo *);
static char       *get_line(FILE *, char *, int, const char **);
...
void load_marker_info(char *fname)
{
  int         i;
  MarkerInfo *newm;
...
static void process_line(char *buf, const char *fname, int idx)
{
  int         tokc;
  char      **tokv;
  const char *msg;
...
static const char *decode_marker_info(int tokc, char **tokv)
{
  double      lat;
  double      lon;
  char       *label;
  ...
  else
  {
    ...
    else
    {
       ...
       */
      rslt = decode_extra_marker_info(tokc-3, tokv+3, newm);
    }
  }
...
static const char *decode_extra_marker_info(int tokc, char **tokv, MarkerInfo *inf)
{
  int   i;
  char *key;
  char *val;
...
static char *get_line(FILE *ins, char *buf, int len, const char **msg)
{
  int   ch;
  char *rslt;
...
void show_marker_info(char *fname)
{
  MarkerInfo *minfo;
